...
var descriptorValues = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Dot']);
var metadataTypes = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
...
var descriptorValues2 = import('./descriptors-3K7UWYEF.mjs').then(
  (module) => module['Dot_coretime']
);
var metadataTypes2 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset2 = {};
var getMetadata2 = () =>
  import('./dot_coretime_metadata-3YB275A2.mjs').then((module) =>
    toBinary('default' in module ? module.default : module)
  );
...
var descriptorValues3 = import('./descriptors-3K7UWYEF.mjs').then(
  (module) => module['Ksm_coretime']
);
var metadataTypes3 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset3 = {};
var getMetadata3 = () =>
  import('./ksm_coretime_metadata-SPRZCAHP.mjs').then((module) =>
    toBinary('default' in module ? module.default : module)
  );
...
var descriptorValues4 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Ksm']);
var metadataTypes4 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset4 = {};
var getMetadata4 = () =>
...
var descriptorValues5 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Pas']);
var metadataTypes5 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset5 = {};
var getMetadata5 = () =>
...
var descriptorValues6 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Wnd']);
var metadataTypes6 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset6 = {};
var getMetadata6 = () =>
...
var descriptorValues7 = import('./descriptors-3K7UWYEF.mjs').then(
  (module) => module['Wnd_coretime']
);
var metadataTypes7 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset7 = {};
var getMetadata7 = () =>
...
var descriptorValues8 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Rx_ksm']);
var metadataTypes8 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset8 = {};
var getMetadata8 = () =>
...
var descriptorValues9 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Ksm_people']);
var metadataTypes9 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset9 = {};
var getMetadata9 = () =>
...
var descriptorValues10 = import('./descriptors-3K7UWYEF.mjs').then(
  (module) => module['Pas_people']
);
var metadataTypes10 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset10 = {};
var getMetadata10 = () =>
...
var descriptorValues11 = import('./descriptors-3K7UWYEF.mjs').then(
  (module) => module['Wnd_people']
);
var metadataTypes11 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset11 = {};
var getMetadata11 = () =>
...
var descriptorValues12 = import('./descriptors-3K7UWYEF.mjs').then(
  (module) => module['Dot_people']
);
var metadataTypes12 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset12 = {};
var getMetadata12 = () =>
...
var descriptorValues13 = import('./descriptors-3K7UWYEF.mjs').then(
  (module) => module['Pas_coretime']
);
var metadataTypes13 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset13 = {};
var getMetadata13 = () =>
  import('./pas_coretime_metadata-5ETDFPS3.mjs').then((module) =>
    toBinary('default' in module ? module.default : module)
  );
var genesis13 = '0xc806038cc1d06766f23074ade7c5511326be41646deabc259970ff280c82a464';
var _allDescriptors13 = {
  descriptors: descriptorValues13,
  metadataTypes: metadataTypes13,
  asset: asset13,
...
var descriptorValues14 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Ksm_ah']);
var metadataTypes14 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset14 = {};
var getMetadata14 = () =>
  import('./ksm_ah_metadata-VOWDBJTW.mjs').then((module) =>
    toBinary('default' in module ? module.default : module)
  );
var genesis14 = '0x48239ef607d7928874027a43a67689209727dfb3d3dc5e5b03a39bdc2eda771a';
var _allDescriptors14 = {
  descriptors: descriptorValues14,
  metadataTypes: metadataTypes14,
  asset: asset14,
...
// .papi/descriptors/src/dot_ah.ts
var descriptorValues15 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Dot_ah']);
var metadataTypes15 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset15 = {};
var getMetadata15 = () =>
  import('./dot_ah_metadata-CADWSUDO.mjs').then((module) =>
    toBinary('default' in module ? module.default : module)
  );
var genesis15 = '0x68d56f15f85d3136970ec16946040bc1752654e906147f7e43e9d539d7c3de2f';
var _allDescriptors15 = {
  descriptors: descriptorValues15,
  metadataTypes: metadataTypes15,
  asset: asset15,
  getMetadata: getMetadata15,
  genesis: genesis15,
};
var dot_ah_default = _allDescriptors15;

// .papi/descriptors/src/pas_ah.ts
var descriptorValues16 = import('./descriptors-3K7UWYEF.mjs').then((module) => module['Pas_ah']);
var metadataTypes16 = import('./metadataTypes-YDZ5EFIR.mjs').then((module) =>
  toBinary('default' in module ? module.default : module)
);
var asset16 = {};
var getMetadata16 = () =>
  import('./pas_ah_metadata-G5EFR5FJ.mjs').then((module) =>
    toBinary('default' in module ? module.default : module)
  );
var genesis16 = '0xd6eec26135305a8ad257a20d003357284c8aa03d0bdb2b357ab0a22371e11ef2';
var _allDescriptors16 = {
  descriptors: descriptorValues16,
  metadataTypes: metadataTypes16,
  asset: asset16,
  getMetadata: getMetadata16,
  genesis: genesis16,
};
var pas_ah_default = _allDescriptors16;
...
var metadatas = {
  ...
  ['0x274e1781dc36a23a922f9ec1e04afe0496a503612c4d57aa4fa0c8bf55b1237a']: dot_ah_default,
  ['0x6629e908ca95b0ac1fa2ee6838d83ecec217ee5a4587dc9616c2c06e4611681d']: pas_ah_default,
};
var getMetadata17 = async (codeHash) => {
  try {
