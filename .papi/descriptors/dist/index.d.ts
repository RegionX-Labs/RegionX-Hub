...
export { default as ksm_people, Ksm_peopleCallData } from './ksm_people';
export type * from './ksm_people';
export { default as wnd_people, Wnd_peopleCallData } from './wnd_people';
export type * from './wnd_people';
export { default as pas_people, Pas_peopleCallData } from './pas_people';
