...
export type Dot_coretimeDispatchError = Anonymize<Ieomelrcrr6qh5>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Dot_coretimeCalls = TxFromPalletsDef<PalletsTypedef>;
export type Dot_coretimeEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Dot_coretimeErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Dot_coretimeConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Dot_coretimeViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Dot_coretimeCallData = Anonymize<Iej7uo9d8c90rd> & {
    value: {
        type: string;
    };
};
export type Dot_coretimeWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
