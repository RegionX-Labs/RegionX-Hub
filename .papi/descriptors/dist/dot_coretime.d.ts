...
type IRuntimeCalls = {
    ...
    DryRunApi: {
         ...
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: DotXcmVersionedLocation, xcm: DotXcmVersionedXcm], Anonymize<I8skdub5dr5kml>>;
    };
    /**
...
export type Dot_coretimeDispatchError = Anonymize<I6iir5b1cc0ncm>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Dot_coretimeCallData = Anonymize<I9eibd2giu4tl7> & {
    value: {
        type: string;
    };
};
