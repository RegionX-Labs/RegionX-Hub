...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<Ibqu3kf8ifskue>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [origin: PolkadotRuntimeOriginCaller, call: Anonymize<Ibqu3kf8ifskue>],
      Anonymize<I399nsqbaqlr2u>
    >;
    /**
     * Dry run XCM program
     */
...
export type PasDispatchError = Anonymize<I50ikjune0gg0u>;
type PalletsTypedef = {
  __storage: IStorage;
  __tx: ICalls;
  __event: IEvent;
...
export type PasCallData = Anonymize<Ibqu3kf8ifskue> & {
  value: {
    type: string;
  };
};
