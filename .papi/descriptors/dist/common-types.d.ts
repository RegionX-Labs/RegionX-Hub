...
export type I1p1369d52j8jd = ResultPayload<Array<DotXcmVersionedAssetId>, Anonymize<Iavct6f844hfju>>;
...
export type If2tjlchftm7hb = ResultPayload<Anonymize<Ia1u1r3n74r13c>, {
    "post_info": Anonymize<Ia1u1r3n74r13c>;
...
export type I6piac7omi5lpd = [Array<{
    "delegate": SS58String;
    "proxy_type": Anonymize<Ib9ifr8gu9ttks>;
    "delay": number;
}>, bigint];
...
export type Ibua694c9eauuo = ResultPayload<Anonymize<Ia1u1r3n74r13c>, {
    "post_info": Anonymize<Ia1u1r3n74r13c>;
    "error": Anonymize<Icrq77kirg75d3>;
}>;
...
export type I7rqj1laarti4a = [Array<{
    "delegate": SS58String;
    "proxy_type": Anonymize<I4usd2cn59lcla>;
    "delay": number;
}>, bigint];
