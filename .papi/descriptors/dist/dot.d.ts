...
type IRuntimeCalls = {
    ...
    DryRunApi: {
         ...
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: DotXcmVersionedLocation, xcm: DotXcmVersionedXcm], Anonymize<I76k77qd5gtluu>>;
    };
    /**
