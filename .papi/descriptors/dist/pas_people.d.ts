...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<Icih4jla0h88nh>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [
        ...
        call: Anonymize<Icih4jla0h88nh>,
        result_xcms_version: number,
      ],
      Anonymize<If3gv4vsdch1kj>
    >;
    /**
     * Dry run XCM program
     */
...
export type Pas_peopleWhitelistEntry =
  | PalletKey
