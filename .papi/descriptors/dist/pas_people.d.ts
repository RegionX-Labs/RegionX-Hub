...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Idnmnq6dud8moj>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I7ng4nqvoc0qmf>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Idh8mh2ng3cbun>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I7ng4nqvoc0qmf>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I3eh5r9uj7evp0>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I7ng4nqvoc0qmf>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I41o3d1a031odn>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I7kai1f957ut>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I5kria4n4fblv8>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I76288me3d4v9q>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I96c2mctqt2esi>>;
    };
    Identity: {
        /**
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<If32i8e3k1l3t1>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         * This function does not check the weight of the call, and instead allows the
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<I41o3d1a031odn>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<Iapcctk4va8fs9>>;
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<Icpe9p35n6c9ir>>;
        /**
         * `:code` was updated.
         */
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Ibgstak3nip2np>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I9f9t5p3hibct5>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I6el8fnuvscrss>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Icmcrqc779898n>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I6el8fnuvscrss>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I2eqbuutpv48u7>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I2eqbuutpv48u7>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Iatb6k28o0mqqn>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Icih4jla0h88nh>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Icih4jla0h88nh>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I42ficri7uep20>, call: Anonymize<Icih4jla0h88nh>, result_xcms_version: number], Anonymize<If3gv4vsdch1kj>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Ibf9el31249od7>>;
    };
    /**
...
export type Pas_peopleDispatchError = Anonymize<I2ac5ca2ttepv9>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Pas_peopleCalls = TxFromPalletsDef<PalletsTypedef>;
export type Pas_peopleEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Pas_peopleErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Pas_peopleConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Pas_peopleViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Pas_peopleCallData = Anonymize<Icih4jla0h88nh> & {
    value: {
        type: string;
    };
};
export type Pas_peopleWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
