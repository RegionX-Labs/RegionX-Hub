...
export type Ksm_peopleDispatchError = Anonymize<I2ip01vbaro6bh>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Ksm_peopleCalls = TxFromPalletsDef<PalletsTypedef>;
export type Ksm_peopleEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Ksm_peopleErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Ksm_peopleConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Ksm_peopleViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Ksm_peopleCallData = Anonymize<I88ntqk88m9l9d> & {
    value: {
        type: string;
    };
};
export type Ksm_peopleWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
