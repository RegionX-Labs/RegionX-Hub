...
type IStorage = {
  ...
  Ismp: {
     ...
     * Used in ensuring that the configured challenge period elapses.
     */
    StateMachineUpdateTime: StorageDescriptor<
      [Key: Anonymize<Ifm3n51g640vse>],
      bigint,
      true,
      never
  ...
  Regions: {
     ...
     */
    Regions: StorageDescriptor<
      [Key: Anonymize<I1vf976h89f2ls>],
      Anonymize<I909f4uo6ptsk0>,
      true,
      never
    >;
  };
...
type IRuntimeCalls = {
  ...
  MmrRuntimeApi: {
    ...
    generate_proof: RuntimeDescriptor<
      [commitments: Anonymize<I88s970jldn57s>],
      Anonymize<I45m73jq9efldg>
    >;
  };
  /**
  ...
  IsmpRuntimeApi: {
     ...
     */
    state_machine_update_time: RuntimeDescriptor<
      [id: Anonymize<Ifm3n51g640vse>],
     ...
     */
    latest_state_machine_height: RuntimeDescriptor<
     ...
     */
    requests: RuntimeDescriptor<
      [request_commitments: Anonymize<Ic5m5lp1oioo8r>],
      Anonymize<Icad0fteo3kki0>
    >;
    /**
     * Fetch the responses for the given commitments.
     */
    responses: RuntimeDescriptor<
      [response_commitments: Anonymize<Ic5m5lp1oioo8r>],
      Anonymize<Idh09c22dpqo2s>
    >;
  };
  /**
...
export type Rx_ksmWhitelistEntry =
  | PalletKey
