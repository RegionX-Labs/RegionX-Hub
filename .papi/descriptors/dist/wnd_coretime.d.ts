...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<Iap7tiv560me91>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [
        ...
        call: Anonymize<Iap7tiv560me91>,
        result_xcms_version: number,
      ],
      Anonymize<I4on1nlqkgntu4>
    >;
    /**
     * Dry run XCM program
     */
...
export type Wnd_coretimeDispatchError = Anonymize<I5gu4h8f0am1te>;
type PalletsTypedef = {
  __storage: IStorage;
  __tx: ICalls;
  __event: IEvent;
...
export type Wnd_coretimeWhitelistEntry =
  | PalletKey
