...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Iftdsra7kkk2o6>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         * event is deposited.
         */
        batch: TxDescriptor<Anonymize<I2r7egdt2s4kg>>;
        /**
         ...
         */
        as_derivative: TxDescriptor<Anonymize<Iaia299t3qcdln>>;
        /**
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I2r7egdt2s4kg>>;
        /**
         ...
         * - O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I7bet1m8alsl5v>>;
        /**
         * Send a batch of dispatch calls.
         ...
         * - O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I2r7egdt2s4kg>>;
        /**
         ...
         * The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I9sbcntook53q2>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I7tp6ue1dd65h2>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I7dc4d1c216env>>;
        /**
         * Register approval for a dispatch to be made from a deterministic composite account if
         * approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I221t08g3aeu51>>;
        /**
         ...
         * - `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I175gn9t0t5bhb>>;
    };
    Identity: {
        /**
...
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I5qc7341tuh6m0>>;
        /**
         * `:code` was updated.
         */
    ...
    Utility: {
         ...
         * well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<I34b0nakvfcmte>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ib720hthqtt8kt>>;
        /**
         * A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I9j3sgj1c9kjkp>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<I25gao91mt74g2>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I9j3sgj1c9kjkp>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Ic1526nmfn29nv>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I88ntqk88m9l9d>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I88ntqk88m9l9d>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call V2.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I42ficri7uep20>, call: Anonymize<I88ntqk88m9l9d>, result_xcms_version: number], Anonymize<I2sbif08sgijmm>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Iekqh9il260t0r>>;
    };
    /**
...
export type Dot_peopleDispatchError = Anonymize<I2ip01vbaro6bh>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
declare const _allDescriptors: Dot_people;
export default _allDescriptors;
export type Dot_peopleApis = ApisFromDef<IRuntimeCalls>;
export type Dot_peopleQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Dot_peopleCalls = TxFromPalletsDef<PalletsTypedef>;
export type Dot_peopleEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Dot_peopleErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Dot_peopleConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Dot_peopleViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Dot_peopleCallData = Anonymize<I88ntqk88m9l9d> & {
    value: {
        type: string;
    };
};
export type Dot_peopleWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
