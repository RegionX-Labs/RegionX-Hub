...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<I88ntqk88m9l9d>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [
        ...
        call: Anonymize<I88ntqk88m9l9d>,
        result_xcms_version: number,
      ],
      Anonymize<I2sbif08sgijmm>
    >;
    /**
     * Dry run XCM program
     */
...
export type Dot_peopleWhitelistEntry =
  | PalletKey
