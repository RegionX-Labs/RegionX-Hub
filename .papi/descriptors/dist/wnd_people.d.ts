...
export type Wnd_peopleDispatchError = Anonymize<Ivklblfpiktda>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
declare const _allDescriptors: Wnd_people;
export default _allDescriptors;
export type Wnd_peopleApis = ApisFromDef<IRuntimeCalls>;
export type Wnd_peopleQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Wnd_peopleCalls = TxFromPalletsDef<PalletsTypedef>;
export type Wnd_peopleEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Wnd_peopleErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Wnd_peopleConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Wnd_peopleViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type Wnd_peopleCallData = Anonymize<I45fs67nfa490o> & {
    value: {
        type: string;
    };
};
export type Wnd_peopleWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}` | `view.${NestedKey<PalletsTypedef['__view']>}`;
