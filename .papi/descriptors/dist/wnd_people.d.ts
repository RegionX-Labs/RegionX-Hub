...
type IRuntimeCalls = {
  ...
  TransactionPaymentCallApi: {
    ...
    query_call_info: RuntimeDescriptor<
      [call: Anonymize<I45fs67nfa490o>, len: number],
  ...
  DryRunApi: {
    ...
    dry_run_call: RuntimeDescriptor<
      [
        ...
        call: Anonymize<I45fs67nfa490o>,
        result_xcms_version: number,
      ],
      Anonymize<Ieu6bl1lsgl0ob>
    >;
    /**
     * Dry run XCM program
     */
...
export type Wnd_peopleWhitelistEntry =
  | PalletKey
